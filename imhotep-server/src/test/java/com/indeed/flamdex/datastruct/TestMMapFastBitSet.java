...
public class TestMMapFastBitSet {
    ...
    public void test1() throws IOException {
        try (final MMapFastBitSet bs = new MMapFastBitSet(tmp, 1000, FileChannel.MapMode.READ_WRITE)) {
    ...
    public void test2() throws IOException {
        try (final MMapFastBitSet bs = new MMapFastBitSet(tmp, 128, FileChannel.MapMode.READ_WRITE)) {
    ...
    public void test3() throws IOException {
        try (final MMapFastBitSet bs = new MMapFastBitSet(tmp, 64, FileChannel.MapMode.READ_WRITE)) {
            assertEquals(0, bs.cardinality());
            bs.setRange(0, 64);
            assertEquals(64, bs.cardinality());
            for (int i = 0; i < 64; ++i) {
