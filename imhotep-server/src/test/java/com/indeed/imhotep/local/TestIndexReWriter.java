...
public class TestIndexReWriter {
    ...
    public void testMergingIntTermDocIterator() throws ImhotepOutOfMemoryException, IOException {
        ...
        ImhotepLocalSession session1 = new ImhotepJavaLocalSession(r1);
        ...
        ImhotepLocalSession session2 = new ImhotepJavaLocalSession(r2);
        ...
        ImhotepLocalSession session3 = new ImhotepJavaLocalSession(r3);
    ...
    public void testGroupMerging() throws ImhotepOutOfMemoryException, IOException {
        ...
        final ImhotepLocalSession session1 = new ImhotepJavaLocalSession(r1);
        ...
        final ImhotepLocalSession session2 = new ImhotepJavaLocalSession(r2);
