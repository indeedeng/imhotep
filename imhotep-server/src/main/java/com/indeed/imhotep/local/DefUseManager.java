...
public class DefUseManager {
    ...
    public List<ListenableFuture<Object>> getAllUses() {
        final List<ListenableFuture<Object>> retval = new ArrayList<>();
        defUseListMap.forEach((s, defUseList) -> retval.addAll(defUseList.uses));
        return retval;
    }

    public List<ListenableFuture<Object>> getAllDef() {
        final List<ListenableFuture<Object>> retval = new ArrayList<>();
        defUseListMap.forEach((s, defUseList) -> retval.add(defUseList.def));
        return retval;
    }
