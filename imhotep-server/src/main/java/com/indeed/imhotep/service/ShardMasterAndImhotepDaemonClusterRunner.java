...
public class ShardMasterAndImhotepDaemonClusterRunner {
    ...
    @Nullable
    private DynamicShardLocator dynamicShardLocator = null;
    @Nullable
    ...
    public void setDynamicShardLocator(final DynamicShardLocator dynamicShardLocator) {
