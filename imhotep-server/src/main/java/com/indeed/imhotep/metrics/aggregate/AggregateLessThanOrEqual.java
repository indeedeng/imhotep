 ...
 * @author jwolfe
 */
public class AggregateLessThanOrEqual implements AggregateStat {
    private final AggregateStat lhs;
    private final AggregateStat rhs;

    public AggregateLessThanOrEqual(AggregateStat lhs, AggregateStat rhs) {
        this.lhs = lhs;
        this.rhs = rhs;
    }
    ...
    public boolean equals(Object o) {
        ...
        AggregateLessThanOrEqual that = (AggregateLessThanOrEqual) o;
    ...
    public String toString() {
        return "AggregateLessThanOrEqual{" +
                "lhs=" + lhs +
                ", rhs=" + rhs +
                '}';
    }
