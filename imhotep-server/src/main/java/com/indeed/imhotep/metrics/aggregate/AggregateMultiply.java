 ...
 * @author jwolfe
 */
public class AggregateMultiply implements AggregateStat {
    private final AggregateStat lhs;
    private final AggregateStat rhs;

    public AggregateMultiply(AggregateStat lhs, AggregateStat rhs) {
        this.lhs = lhs;
        this.rhs = rhs;
    }
    ...
    public boolean equals(Object o) {
        ...
        AggregateMultiply that = (AggregateMultiply) o;
