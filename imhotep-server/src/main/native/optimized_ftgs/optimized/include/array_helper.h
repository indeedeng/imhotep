...
#define ROW_LOOP_WITH_PREFETCH(data_desc, data_array, row_size, row_idx)                       \
{                                                                                              \
...
static void prefetch_and_process_array(DESC_TYPE data_desc,
                                  __m128i *data_array,
                                  int row_size)
{
    /*
	...
	for (int row_counter = 0; row_counter < num_rows - prefetch_rows; row_counter ++) {
    {
        ...
        /* loop through row elements */
        ROW_LOOP_WITH_PREFETCH(data_desc, data_array, row_size, row_idx);
    }
