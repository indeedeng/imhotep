 ...
 * @author jplaisance
 */
public interface StringTermDocIterator extends TermDocIterator {
    String term();
     ...
     * iterator before reading the bytes then you need to copy them into another array before calling nextTerm() method
