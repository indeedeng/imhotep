...
public interface ImhotepServiceCore {
    ...
    void handleGetFTGSIteratorSplit(String sessionId, String[] intFields, String[] stringFields, OutputStream os, int splitIndex, int numSplits, long termLimit, final List<List<String>> stats, final boolean useFtgsPooledConnection) throws IOException, ImhotepOutOfMemoryException;
    void handleGetSubsetFTGSIteratorSplit(String sessionId, Map<String, long[]> intFields, Map<String, String[]> stringFields, final List<List<String>> stats, OutputStream os, int splitIndex, int numSplits, final boolean useFtgsPooledConnection) throws IOException, ImhotepOutOfMemoryException;
