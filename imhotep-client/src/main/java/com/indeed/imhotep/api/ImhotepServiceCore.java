...
public interface ImhotepServiceCore {
    ...
    void handleRandomMetricRegroup(String sessionId, int stat, String salt, double p, int targetGroup, int negativeGroup, int positiveGroup) throws ImhotepOutOfMemoryException;
    void handleRandomMetricMultiRegroup(String sessionId, int stat, String salt, int targetGroup, double[] percentages, int[] resultGroups) throws ImhotepOutOfMemoryException;
    ...
    void handleMergeSubsetFTGSIteratorSplit(String sessionId, Map<String, long[]> intFields, Map<String, String[]> stringFields, OutputStream os, HostAndPort[] nodes, int splitIndex) throws IOException;
