...
public interface ImhotepServiceCore {
    ...
    void handleGetFTGSIteratorSplitNative(String sessionId, String[] intFields, String[] stringFields, OutputStream os, int splitIndex, int numSplits, Socket socket) throws IOException;
