...
public interface ImhotepServiceCore {
    ...
    void handleGetSubsetFTGSIterator(String sessionId, Map<String, long[]> intFields, Map<String, String[]> stringFields, final List<List<String>> stats, OutputStream os) throws IOException;
    void handleGetFTGSIteratorSplit(String sessionId, String[] intFields, String[] stringFields, OutputStream os, int splitIndex, int numSplits, long termLimit, final List<List<String>> stats) throws IOException;
    void handleGetSubsetFTGSIteratorSplit(String sessionId, Map<String, long[]> intFields, Map<String, String[]> stringFields, final List<List<String>> stats, OutputStream os, int splitIndex, int numSplits) throws IOException;
    void handleMergeFTGSIteratorSplit(String sessionId, FTGSParams params, OutputStream os, HostAndPort[] nodes, int splitIndex) throws IOException;
    void handleMergeSubsetFTGSIteratorSplit(String sessionId, Map<String, long[]> intFields, Map<String, String[]> stringFields, final List<List<String>> stats, OutputStream os, HostAndPort[] nodes, int splitIndex) throws IOException;
    void handleMergeMultiFTGSSplit(MultiFTGSRequest request, String validLocalSessionId, OutputStream os, HostAndPort[] nodes) throws IOException;
    long handleGetTotalDocFreq(String sessionId, String[] intFields, String[] stringFields);
    GroupStatsIterator handleGetGroupStats(String sessionId, List<String> stat);
    ...
    GroupStatsIterator handleMergeMultiDistinctSplit(final MultiFTGSRequest request, final String validLocalSessionId, final HostAndPort[] nodes);
