...
public class SortedFTGInterleaver<T extends FTGIterator> extends AbstractDisjointFTGMerger<T> {

    private boolean initialized = false;

    public SortedFTGInterleaver(final T[] iterators) {
        super(iterators);
    }
